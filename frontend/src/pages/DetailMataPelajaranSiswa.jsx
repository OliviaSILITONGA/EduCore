  ...
  return (
    <div className="flex w-screen h-screen bg-gray-100 font-sans overflow-hidden">
      ...
      <aside className="w-[250px] bg-[#27B4E3] text-white flex flex-col items-center pt-8 min-h-screen">
        <img src={Logo} className="h-25 mb-6" alt="Logo Educore" />
        ...
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
            {kelasList.map((kelas) => (
              <div
                key={kelas.id}
                className="bg-white rounded-xl shadow p-5 border border-gray-200 flex flex-col justify-between h-44"
              >
                {/* HEADER CARD */}
                ...
                {/* BUTTON */}
                <Button
                  className={`mt-3 px-4 py-2 text-sm font-semibold rounded ${
