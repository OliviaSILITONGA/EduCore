    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-blue-600 text-white">
        <div className="p-6 flex flex-col items-center">
          ...
          <p className="text-sm text-blue-100 mb-8">Profil Siswa</p>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="md:hidden bg-blue-600 text-white">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <h1 className="text-lg font-semibold">Profil Siswa</h1>
            
            <button
              onClick={() => navigate("/edit-profil-siswa")}
              className="p-2"
            >
              <Edit3 size={20} />
            </button>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                <div>
                  ...
                  <p className="text-gray-600">
                    Informasi profil dan data belajar Anda
                  </p>
                </div>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4">
                        <div>
                          ...
                          <p className="text-gray-600 flex items-center gap-2">
                            ...
                            {profile?.tingkat || "Siswa"} • Kelas {profile?.kelas || "-"}
                          </p>
                        </div>
              ...
              <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                        <Phone size={18} className="text-gray-500" />
                        <div className="flex-1">
                          <p className="text-xs text-gray-500">Telepon Orang Tua/Wali</p>
                          <p className="font-medium">
                            {profile?.ortuTelepon || "-"}
                          </p>
                        </div>
                  ...
                  <div className="bg-blue-500 rounded-lg shadow p-6 text-white">
                    <h3 className="text-lg font-bold mb-6">Statistik Belajar</h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-blue-100">Tugas Selesai</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-blue-100">Kehadiran</p>
