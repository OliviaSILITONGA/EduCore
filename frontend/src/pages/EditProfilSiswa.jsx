            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-lg font-bold text-gray-800">Alamat Tempat Tinggal</h3>
                </div>
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-lg font-bold text-gray-800">Informasi Orang Tua/Wali</h3>
                </div>
