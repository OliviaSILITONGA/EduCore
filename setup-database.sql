...
CREATE INDEX idx_siswa_id_akun ON siswa(id_akun);
CREATE INDEX idx_guru_id_akun ON guru(id_akun);
CREATE INDEX idx_materi_id_guru ON materi(id_guru);
CREATE INDEX idx_materi_id_matpel ON materi(id_matpel);
CREATE INDEX idx_materi_id_kelas ON materi(id_kelas);
CREATE INDEX idx_pembelajaran_id_siswa ON pembelajaran(id_siswa);
CREATE INDEX idx_pembelajaran_id_materi ON pembelajaran(id_materi);
CREATE INDEX idx_detail_kelas_id_siswa ON detail_kelas(id_siswa);
CREATE INDEX idx_detail_kelas_id_matpel ON detail_kelas(id_matpel);
